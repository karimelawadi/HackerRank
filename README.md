...
| 3 | Python If-Else | Print "Weird" or "Not Weird" based on given conditions |
| 4 | Print Function | Print integers from 1 to n without spaces |
| 5 | Leap Year | Determine whether a given year is a leap year |
